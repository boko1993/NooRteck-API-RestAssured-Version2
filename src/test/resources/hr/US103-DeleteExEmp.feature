Feature: Delete Existing Employee API
  ...
  Scenario Outline: Verify User able to delete existing employee
    ...
    Examples: 
      ...
      | "scrum" | "Employee:DeleteEmp" | "200"      | 'EmpTestData:scrum:0' | Successfully deleted | "210" |
      | "scrum" | "Employee:DeleteEmp" | "200"      | 'EmpTestData:scrum:0' | Successfully deleted | "211" |
      | "scrum" | "Employee:DeleteEmp" | "200"      | 'EmpTestData:scrum:0' | Successfully deleted | "212" |
      | "scrum" | "Employee:DeleteEmp" | "200"      | 'EmpTestData:scrum:0' | Successfully deleted | "213" |
      | "scrum" | "Employee:DeleteEmp" | "200"      | 'EmpTestData:scrum:0' | Successfully deleted | "214" |
      | "scrum" | "Employee:DeleteEmp" | "200"      | 'EmpTestData:scrum:0' | Successfully deleted | "215" |
